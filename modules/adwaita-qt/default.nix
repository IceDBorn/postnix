...
let
  accentColorPatch = ''
    ...
    +@define-color selected_bg_color #7E57C2;
    ...
    +@define-color link_color #7E57C2;
    +@define-color link_visited_color #7E57C2;
    ...
    +@define-color scrollbar_slider_active_color #7E57C2;
    ...
    +checkradio:checked { background-clip: border-box; background-image: #7E57C2; border-color: #092444; box-shadow: 0 1px rgba(0, 0, 0, 0.05); color: #ffffff; }

    -checkradio:checked:hover { background-image: linear-gradient(to bottom, #1b68c6 10%, #185cb0 90%); }
    +checkradio:checked:hover { background-image: #7E57C2; }

    -checkradio:checked:active { box-shadow: inset 0 1px black; background-image: image(#124787); }
    +checkradio:checked:active { box-shadow: inset 0 1px black; background-image: image(#7E57C2); }
